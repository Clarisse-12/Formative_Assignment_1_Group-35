...
class ALUColors {
  ...
  // attendance color
  static const Color attendanceGood = Color(0xFF28A745); //over 75% green
  static const Color attendanceWarning = Color(0xFFFDB827); //between 60-75% yellow
  static const Color attendanceCritical = Color(0xFFDC3545); //less 60% red
}
